...
- Quando vão pagar meu RPV
- Quando vão pagar minha Req Peq Valor
- Quando vão pagar minha Requisição de Pequeno Valor
- Quando vao pagar meu RPV
- Quando vao pagar minha Req Peq Valor
- Quando vao pagar minha Requisicao de Pequeno Valor

- Quando cairá meu RPV
- Quando cairá minha Req Peq Valor
- Quando cairá minha Requisição de Pequeno Valor
- Quando caira meu RPV
- Quando caira minha Req Peq Valor
- Quando caira minha Requisicao de Pequeno Valor



- Quando será o depósito de meu RPV
- Quando sera o deposito de meu RPV
- Quando será o depósito da minha RPV
- Quando será o depósito da minha Req Peq Valor
- Quando será o depósito da minha Requisição de Pequeno Valor
- Quando sera o deposito da minha RPV
- Quando sera o deposito da minha Req Peq Valor
- Quando sera o deposito da minha Requisicao de Pequeno Valor
- Quando depositam
- Quando depósito RPV
- Quando deposito  RPV
- Depositar Requisição de Pequeno Valor
- Deposito RPV
- depósito RPV
- data deposito
- data depósito
...
- Qual o prazo pro depósito
- Qual o prazo pro deposito
- Qual o prazo pro pagamento
- Qual o prazo pra eu receber
- Qual prazo  depósito
- Qual prazo deposito
- Qual prazo pagamento
- Qual prazo receber
- Prazo Deposito
- Prazo Recebimento
- Prazo Pagamento
...
- data recebimento
- dia recebimento 
- Qual a data de pagamento do meu RPV
- Qual a data de pagamento da minha Req Peq Valor
- Qual a data de pagamento da minha Requisição de Pequeno Valor
- Qual a data de pagamento da minha Requisicao de Pequeno Valor

- Qual a data limite do meu RPV
...
- acompanhar RPV por OAB
- acompanho RPV por OAB
- buscar RPV por OAB
- busco RPV por OAB
- consultar RPV por OAB
- consulto RPV por OAB
- localizar RPV por OAB
- localizo RPV por OAB
- pesquisar RPV por OAB
- pesquiso RPV por OAB
- procurar RPV por OAB
- procuro RPV por OAB
- situação RPV por OAB
- status RPV por OAB
- RPV por OAB

##intent:pesquisar_RPV_porNumero
- Como pesquiso minha RPV pelo número
- Como pesquiso minha RPV pelo sequencial
- Como pesquiso minha RPV pelo protocolo

- acompanhar RPV pelo número
- acompanhar RPV por número
- acompanho RPV pelo número
- acompanho RPV por número
- buscar RPV pelo número
- buscar RPV por número
- busco RPV pelo número
- busco RPV por número
- consultar RPV pelo número
- consultar RPV por número
- consulto RPV pelo número
- consulto RPV por número
- localizar RPV pelo número
- localizar RPV por número
- localizo RPV pelo número
- localizo RPV por número
- pesquisar RPV pelo número
- pesquisar RPV por número
- pesquiso RPV pelo número
- pesquiso RPV por número
- procurar RPV pelo número
- procurar RPV por número
- procuro RPV pelo número
- procuro RPV por número
- situação RPV pelo número
- situação RPV por número
- status RPV pelo número
- status RPV por número
- RPV pelo número
- RPV por número

- acompanhar RPV pelo numero
- acompanhar RPV por numero
- acompanho RPV pelo numero
- acompanho RPV por numero
- buscar RPV pelo numero
- buscar RPV por numero
- busco RPV pelo numero
- busco RPV por numero
- consultar RPV pelo numero
- consultar RPV por numero
- consulto RPV pelo numero
- consulto RPV por numero
- localizar RPV pelo numero
- localizar RPV por numero
- localizo RPV pelo numero
- localizo RPV por numero
- pesquisar RPV pelo numero
- pesquisar RPV por numero
- pesquiso RPV pelo numero
- pesquiso RPV por numero
- procurar RPV pelo numero
- procurar RPV por numero
- procuro RPV pelo numero
- procuro RPV por numero
- situação RPV pelo numero
- situação RPV por numero
- status RPV pelo numero
- status RPV por numero
- RPV pelo numero
- RPV por numero

- acompanhar RPV pelo sequencial
- acompanhar RPV por sequencial
- acompanho RPV pelo sequencial
- acompanho RPV por sequencial
- buscar RPV pelo sequencial
- buscar RPV por sequencial
- busco RPV pelo sequencial
- busco RPV por sequencial
- consultar RPV pelo sequencial
- consultar RPV por sequencial
- consulto RPV pelo sequencial
- consulto RPV por sequencial
- localizar RPV pelo sequencial
- localizar RPV por sequencial
- localizo RPV pelo sequencial
- localizo RPV por sequencial
- pesquisar RPV pelo sequencial
- pesquisar RPV por sequencial
- pesquiso RPV pelo sequencial
- pesquiso RPV por sequencial
- procurar RPV pelo sequencial
- procurar RPV por sequencial
- procuro RPV pelo sequencial
- procuro RPV por sequencial
- situação RPV pelo sequencial
- situação RPV por sequencial
- status RPV pelo sequencial
- status RPV por sequencial
- RPV pelo sequencial
- RPV por sequencial

- acompanhar RPV pelo protocolo
...
- como é atualizada RPV Tributária
- como é atualizado RPV Tributário
- atualizada rpv tributaria
- atualizado rpv tributario
- corrigido rpv tributario
- corrigida rpv tributaria
- atualização RPV tributária
- correção rpv tributario
- correcao rpv tributario
- atualizacao rpv tributario

- como é atualizada RPV não Tributária
- como é atualizado RPV não Tributário
- atualizada rpv nao tributaria
- atualizada rpv  n tributaria
- atualizado rpv nao tributario
- atualizado rpv n tributario
- corrigido rpv nao tributario
- corrigido rpv n tributario
- corrigida rpv nao tributaria
- corrigida rpv n tributaria
- atualização RPV nao tributária
- atualização RPV n tributária
- correção rpv nao n tributario
- correção rpv nao tributario
- correcao rpv n tributario
- atualizacao rpv nao tributario
- atualizacao rpv n tributario


##intent:nao_tenho_certificado_digital
- não tenho certificado digital
- n tenho certificado digital
- n tenho um certificado
- estou sem certificado digital
- estou sem certificado
